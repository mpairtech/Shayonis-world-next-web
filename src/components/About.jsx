...
const About =() => {
  ...
  return (
    <div className="mt-28 max-w-screen mx-auto px-18 flex flex-col items-center justify-center">
       ...
       <section> <div className=" flex flex-col items-center justify-center  w-fit h-fit mb-12 ">
            <Tag text="About Shayonis World" />
            <p className="text-center text-lg font-normal mt-8 ">Shayonis World is more than a brand—it’s a multi-dimensional lifestyle ecosystem. Born from a passion for excellence <br />  and creativity, Shayonis World brings together three powerful ventures under one roof:</p>
        </div>
        </section>
 
    <section className="bg-[#F9E9D9] w-full py-10 px-12 rounded-3xl"> {/* brown bg */}
      <div className="flex flex-wrap justify-center gap-8">
        {cards.map((card, index) => (
          <div
            ...
            />
            <div>
                <h3 className="text-xl font-medium mb-3 text-gray-800">{card.title}</h3>
