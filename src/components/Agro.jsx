  ...
  return (
    ...
    >
      ...
      <div className=" info-panel flex flex-col md:flex-row gap-4 md:gap-8 items-start">
        ...
        <div className="hidden md:flex flex-col gap-4 w-1/3">
          <div className="flex md:flex-col gap-4 overflow-x-auto md:overflow-visible no-scrollbar pb-2">
            {contentData.map((item, index) => (
              ...
              >
                <span className="text-left lg:text-lg sm:text-sm font-medium">
                  {item.title}
                </span>
        ...
        <div className="hidden md:block w-full relative h-[380px] rounded-2xl overflow-hidden">
          <Image
          ...
          />
          <div className="absolute bottom-0 left-0 w-full h-28 bg-black/50 p-5 text-white flex items-center text-left text-base">
