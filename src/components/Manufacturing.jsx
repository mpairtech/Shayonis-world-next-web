...
export default function Manufacturing() {
 ...
 <div className="text-blue-400 flex flex-row items- justify-end">
      ...
      <div className="text-start mb-4 ">
        ...
        <h2 className=" font-bold  text-[44px] mt-3" style={{ color: "var(--primary-text)"}}>  Shayonis Apparel </h2>
        <p className="font-bold text-[44px]" style={{ color: "var(--secondary-text)"}} >  Where Every Thread Tells a Story        </p>
      ...
      <div  className="carousel-track-wrapper"  >
        ...
        {carouselItems.map((item) => (
          <div key={item.id} className="carousel-slide-card ">
            <Image
              src={item.image}
              alt={item.title}
              width={800}
