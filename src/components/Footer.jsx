...
<div className="relative mission p-12 max-w-10/12 mx-auto text-white text-center font-semibold text-xl leading-relaxed">
      ...
      <p className=" font-bold text-3xl py-4">
        Our mission is to enrich everyday living through quality, innovation, and integrity—
        whether <em>you wear it, eat it, or live in it</em>. Join us as we continue to{' '}
        <em>grow, inspire, and create a legacy</em> across industries.
      </p>
    ...
    >
      <Icon className="text-white text-xl cursor-pointer" />
        ...
        <div className="grid grid-cols-3 gap-2 text-base font-semibold">
          ...
          <a href="#agro" className="hover:underline">Agro</a>
          <a href="#clothing" className="hover:underline">Clothing</a>
        ...
        <div className="space-y-3 text-sm pr-10">
          <div className="flex items-start">
            ...
            <span>
              Shop#350, 2nd floor, Concord Twin Center <br /> Shopping Complex, Khulshi,  Chattogram
            </span>
          </div>
          <div className="flex items-center">
            <MdEmail className="mr-2" />
            <a href="mailto:Shayonisworld@gmail.com" className="hover:underline">
      ...
      <div className="border-t border-gray-400 px-16 py-4 flex flex-row  justify-between  items-center">
        <div className="flex items-center gap-2">
          <span>&copy;</span>
          <span className="text-xs font-medium">Copyright by Shayonis Wolrd.</span>
        </div>
        <div className="text-xs font-medium ">
          Developed by <span className="font-bold">mPair Technologies Ltd.</span>
        </div>
      </div></section>
    </footer>
  );
