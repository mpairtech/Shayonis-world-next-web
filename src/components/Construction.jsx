...
const Construction = () => {
  return (
    ...
    >
      ...
      {/* Main Content */}
<div className="flex flex-col justify-center lg:flex-row items-start md:items-start gap-y-10 lg:gap-x-12">
        {/* - Card  */}
        <div className="relative bg-[#FCF9F4] my-8 md:my-1 w-fit h-fit lg:h-[340px] p-6 rounded-2xl order-1 md:order-2">
          <h4
...
<div className="flex order-2 lg:order-1">
  <div className=" w-full grid grid-cols-1 md:grid-cols-4 gap-4 lg:gap-6 place-items-center">
  ...
  <div className="flex flex-row gap-4 h-[340px] md:flex-row md:col-span-2">
